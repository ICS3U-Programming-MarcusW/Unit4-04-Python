...
# It then checks if they get it wrong, tells them so and then asks for
# a number from 0 and 9 until they guess correctly
import random
...
def main():
    ...
    # use loop to keep asking for a number until they guess right
    while True:
        ...
        try:
            ...
            # Check to see if they inputted a number from 0-9
